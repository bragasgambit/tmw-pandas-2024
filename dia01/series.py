...
for i in idades: # Percorrer todas as idades
    total += (media - i) ** 2 # Pega a média (valor fixo) e subtrai da idade em específico com a iteração, eleva ao quadrado e soma no total
...
series_idades = pd.Series(idades, name = "idades") # Converte uma lista em uma série e atribuindo em uma var nova (ie series_idades)
...
series_idades.iloc[0] # Quando o interesse é só na posição usa o .iloc[] --funciona como lista
