...
sumario = df.describe() # tratar o df como uma planilha onde eu posso acessar como uma série:

print(f"A media dos pesos adicionados posteriormente no DataFrame:", sumario["peso"]["mean"])

df.head() # Mostra as 5 primeiras linhas do df ou .head(n)
df.head() # Mostras as 5 últimas linhas do df ou .tail(n)
